...
Each row has an icon that is clicked to expand and collapse its columns.
...
A child table has similar features to that of a full table. Note that a child table cannot have a child table of itself.
